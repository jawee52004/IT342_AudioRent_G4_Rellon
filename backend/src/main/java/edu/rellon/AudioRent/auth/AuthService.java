...
import edu.rellon.AudioRent.auth.adapter.OAuthProvider;
import edu.rellon.AudioRent.auth.event.UserRegisteredEvent;
import edu.rellon.AudioRent.auth.factory.UserFactory;
import edu.rellon.AudioRent.auth.strategy.UserValidationStrategy;
